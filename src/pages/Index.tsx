              ...
              <div className="skill-category skill-card group relative">
                <div className={`h-full p-5 md:p-8 rounded-2xl backdrop-blur-sm border transition-all duration-500 hover:scale-105 ${isDark
                  ...
                  <div className="text-center mb-6 md:mb-8">
                    ...
                    <h3 className="text-xl md:text-2xl font-bold text-white mb-1">Content & Design</h3>
                    <p className="text-xs md:text-sm text-gray-400 mb-4">Building engaging assets</p>
                    ...
                    {skills.frontend.map((skill, index) => (
                      <div key={skill.name} className="skill-item bg-[#12182A] rounded-xl p-3 md:p-4 border border-white/5" style={{ animationDelay: `${index * 0.1}s` }}>
                        <div className="flex items-center justify-between mb-3">
                          ...
                          <span className="text-xs font-bold text-blue-400 bg-blue-900/40 px-2 py-1 rounded-md">{skill.level}%</span>
                        </div>
                        <div className="relative h-2 bg-gray-800/80 rounded-full overflow-hidden shadow-inner">
                          <div
                            className="h-full bg-gradient-to-r from-blue-600 to-blue-400 rounded-full shadow-[0_0_10px_rgba(59,130,246,0.5)] transition-all duration-1000 ease-out"
                            style={{
                              width: `${skill.level}%`,
